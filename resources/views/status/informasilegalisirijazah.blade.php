...
<section class="content-header">
    <div class="container-fluid mt-4">
      <div class="row mb-2 d-flex justify-content-center">
        <div class="col-sm-5">
            <p class="text-start" id="judulhalaman">Informasi Legalisir Ijazah</p>
        </div>
        <div class="col-sm-5 d-flex justify-content-end">
            <a href="{{route('statuslegalisirijazah')}}">
        ...
        <div class="container" style="background-color: white; width: 1070px; height: 400px">
            <div class="row d-flex justify-content-end p-3" style="font-family: 'Inter', sans-serif;">
                Tanggal Surat : {{date('d-m-Y', strtotime($ijazah->tanggal_kunjungan))}}
            </div>
            ...
            <div class="row d-flex justify-content-center mt-5">
                <p style="font-size: 18px"><i><span>Sedang dikelola oleh</span><span><b> {{$ijazah->penyerahan_kepada}}</b></span></i></p>
            </div>
        </div>
