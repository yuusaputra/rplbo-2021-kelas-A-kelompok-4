            ...
            <form action="" class="p-5">
                <div class="row mt-3">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                      <input value="{{$ijazah->tahun_alumni}}" type="text" class="form-control border border-dark" style="width: 568px" name="tahum_alumni">
                    </div>
                  </div>
                  <div class="row mt-3">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                      ...
                      <div class="row mt-4">
                        <a href="{{route('tampillegalisirijazah')}}"><button type="button" class="btn btn-danger" style="width: 90px">Kembali</button></a>
                    </div>
                    </div>
