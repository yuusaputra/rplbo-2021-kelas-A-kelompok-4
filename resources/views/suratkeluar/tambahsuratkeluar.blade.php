...
<section class="content-header">
    <div class="container-fluid mt-4">
      <div class="row mb-2 d-flex justify-content-center">
        <div class="col-sm-10">
            <p class="text-start" id="judulhalaman">Form Tambah Data Surat Keluar</p>
        </div>
        <div class="col-sm-10" style="background-color: white; width: 1070px; height: 500px">
            <form action="/tambahsuratkeluar" class="p-5" method="POST" enctype="multipart/form-data">
              @csrf
                <div class="row mt-3">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                        <select name="sifat_surat" id="" class="form-control border border-dark" style="width: 568px" required>
