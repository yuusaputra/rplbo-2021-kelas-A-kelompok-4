            ...
            <form action="" class="p-5">
                <div class="row mt-3">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                      <input value="{{$psk->file}}" type="text" class="form-control border border-dark" style="width: 568px" name="password">
                      <div class="row mt-4">
                        <a href="{{route('tampilpengajuansuratkeluar')}}"><button type="button" class="btn btn-danger" style="width: 90px">Kembali</button></a>
                    </div>
                    </div>
